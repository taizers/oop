...
import { createCompanyAction, deleteCompanyAction, getAllCompaniesAction, getCompanyAction, getPaginatedCompaniesAction, updateCompanyAction } from '../controllers/companies.controller';
...
router.get('/all', getAllCompaniesAction);
